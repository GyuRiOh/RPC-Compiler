	...
	private:
		...
		void CreateResponseCode()
		{
			...
			if (fopen_s(&stream, fileName, "w+") == 0)
			{
				...
				fprintf(stream, "#include \"NetRoot/NetServer/NetStub.h\"\n");
				...
				//OnRecv
				fprintf(stream, "\t\tvoid OnRecv(NetPacketSet* msgPack) override\n");
				fprintf(stream, "\t\t{\n");
				fprintf(stream, "\n");
				fprintf(stream, "\t\t}\n");
				fprintf(stream, "\n");
				...
				//OnContentsUserJoin
				fprintf(stream, "\t\tvoid OnContentsUserJoin(NetSessionID sessionID) override\n");
				fprintf(stream, "\t\t{\n");
				fprintf(stream, "\n");
				fprintf(stream, "\t\t}\n");
				fprintf(stream, "\n");
				...
				//OnContentsUserLeave
				fprintf(stream, "\t\tvoid OnContentsUserLeave(NetSessionID sessionID) override\n");
				fprintf(stream, "\t\t{\n");
				fprintf(stream, "\n");
				fprintf(stream, "\t\t}\n");
				fprintf(stream, "\n");
				...
				//OnWorkerClientJoin
				fprintf(stream, "\t\tvoid OnWorkerClientJoin(NetSessionID sessionID) override\n");
				fprintf(stream, "\t\t{\n");
				fprintf(stream, "\n");
				fprintf(stream, "\t\t}\n");
				fprintf(stream, "\n");
				...
				//OnWorkerClientLeave
				fprintf(stream, "\t\tvoid OnWorkerClientLeave(NetSessionID sessionID) override\n");
				fprintf(stream, "\t\t{\n");
				fprintf(stream, "\n");
				fprintf(stream, "\t\t}\n");
				fprintf(stream, "\n");
