...
namespace server_baby
{
	...
	public:
		explicit LanRPCMaker() : procCount_SC_(NULL), procCount_CS_(NULL)
		{
			//파서 싱글톤 좀 오버엔지니어링
			//SC Protocol 파싱
			Parser::GetInstance()->LoadFile("Lan_RPC_SC_Protocol.ini");
			...
			//CS Protocol 파싱
			Parser::GetInstance()->LoadFile("Lan_RPC_CS_Protocol.ini");
